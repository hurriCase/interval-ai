Shader "Custom/TextGradientShader"
{
    Properties
    {
        ...
        _GradientDirection ("Gradient Direction", Range(0,1)) = 0 // 0 = horizontal, 1 = vertical
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                // Preserve the original alpha from the text
                half4 finalColor = half4(gradientColor.rgb, texColor.a * IN.color.a);
