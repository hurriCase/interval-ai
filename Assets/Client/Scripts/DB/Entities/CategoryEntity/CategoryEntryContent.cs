...
{
    [Serializable]
    internal sealed class CategoryEntryContent
    {
        [JsonProperty("title")] [StringLength(3, 50)] [Required] public string Title { get; set; }
        [JsonProperty("description")] [StringLength(3, 250)] public string Description { get; set; }
