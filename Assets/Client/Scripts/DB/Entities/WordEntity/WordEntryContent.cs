...
namespace Client.Scripts.DB.Entities.WordEntity
{
    ...
    {
        [JsonProperty("categoryId")] [Required] public string CategoryId { get; set; }
        [JsonProperty("nativeWord")] [StringLength(1, 100)] [Required] public string NativeWord { get; set; }
        [JsonProperty("learningWord")] [StringLength(1, 100)] [Required] public string LearningWord { get; set; }
