...
namespace Client.Scripts.DB.Entities.ProgressEntity
{
    ...
    internal sealed class ProgressEntryContent
    {
        ...
        [JsonProperty("wordId")] [StringLength(1, 100)] [Required] public string WordId { get; set; }
        [JsonProperty("repetitionStage")] [NumericRange(1, 5)] [Required] public int RepetitionStage { get; set; }
