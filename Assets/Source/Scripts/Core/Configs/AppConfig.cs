...
namespace Source.Scripts.Core.Configs
{
    internal sealed class AppConfig : ScriptableObject, IAppConfig
    {
        ...
        [field: SerializeField] public EnumArray<PracticeState, ModuleType> PracticeToModuleType { get; private set; }
        ...
        public bool IsTargetLearningState(PracticeState practiceState, LearningState learningState) =>
            TargetLearningStatesForPractice[practiceState].Contains(learningState);
    }
}